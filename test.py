...
from models.team22_HAT.io import main as hat_main
...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        # HAT
        name = f"{model_id:22}_HAT"
        model_path = os.path.join('model_zoo', 'team22_HAT.pth')
        model_func = hat_main  # Use the main function from io.py
    else:
